...
const Sidebar: FC<SidebarProps> = ({userWorkspacesData, currentWorkspaceData, userData}) => {
    ...
    return(
        <aside className={`fixed top-0 left-0 pt-[68px] pb-8 z-30 flex flex-col justify-between items-center h-screen w-20 text-white`}>
            <SidebarNav currentWorkspaceData={currentWorkspaceData} userWorkspacesData={userWorkspacesData}  />
                                    ...
                                    <PopoverContent side="right">
                                        <div>
                                            <div className="flex space-x-3">
                                                ...
                                                <div className="flex flex-col">
                                                    ...
                                                    <div className="flex items-center space-x-1">
                                                        {userData.is_away ? <GiNightSleep size="12" /> : <GoDotFill className="text-green-500" size="17" /> }
                                            ...
                                            <div className="flex flex-col space-y-1">
                                                <Typography 
                                                    variant="p" 
                                                    text={userData.is_away ? 'Set yourself as active' : 'Set yourself as away'} 
                                                ...
                                                <Typography variant="p" text={`Signout of ${currentWorkspaceData.name}`} className="hover:text-white hover:bg-blue-700 px-2 py-1 cursor-pointer" />
