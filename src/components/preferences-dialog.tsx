    ...
    return(
        <Dialog>
            <DialogTrigger asChild>
                <Typography className="hover:text-white hover:bg-blue-700 px-2 py-1 rounded cursor-pointer" text="Preferences" variant="p" />
            </DialogTrigger>
            <DialogContent className="max-w-xs md:w-fit">
                ...
                <Tabs orientation="horizontal" defaultValue="themes">
                    ...
                    <TabsContent className="max-w-xs md:max-w-fit" value="themes">
                        ...
                        <Typography className="pb-4" text="Choose if slackzz appearance should be light or dark, or follow the computter settings" />
                        ...
                        <div className="flex flex-wrap gap-5">
                            <Button variant="outline" onClick={() => selectColor("green")} className="w-full hover:border-green-800 border-2">
                                Green
                            </Button>
                            <Button variant="outline" onClick={() => selectColor("blue")} className="w-full hover:border-blue-800 border-2">
                                Blue
                            </Button>
                            <Button variant="outline" onClick={() => selectColor("")} className="w-full hover:border-red-800 border-2">
                                Reset
                            </Button>
                        </div>
                    </TabsContent>
