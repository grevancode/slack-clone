...
const IntroBanner: FC<IntroBannerProps> = ({
    ...
    const channelMessage = creationDate
        ? `You created this channel on ${format(new Date(creationDate), 'd MMM yyyy')}. This is the very beginning of the ${name} channel. This channel is for everything ${name}. Hold meetings, share docs, and make decisions together.` 
        : "";
